...
def main(val = 4, mask_moving =  False):
    #Fixed = i, Moving = e
    ...
    if mask_moving:
        mask_moving = fr"C:\Users\User\Desktop\UDG_old_pc\UDG\Subjects\MIRRRRA\Final_project\Training data-20241123\copd{val}\copd{val}\copd{val}_mask_eBHCT.nii".replace("\\", "/")
    else:
        mask_moving = None
    #mask_fixed = fr"C:\Users\User\Desktop\UDG_old_pc\UDG\Subjects\MIRRRRA\Final_project\Training data-20241123\copd{val}\copd{val}\MaskPabloOld\correct_copd{val}_iBHCT_lung_mask.nii".replace("\\", "/")
    #mask_moving = fr"C:\Users\User\Desktop\UDG_old_pc\UDG\Subjects\MIRRRRA\Final_project\Training data-20241123\copd{val}\copd{val}\MaskPabloOld\correct_copd{val}_eBHCT_lung_mask.nii".replace("\\", "/")
    ...
    param_file = fr"C:\Users\User\Desktop\UDG_old_pc\UDG\Subjects\MIRRRRA\Final_project\Transform_params\Parameters_BSpline_changes.txt".replace("\\", "/")
