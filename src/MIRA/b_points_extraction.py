...
if __name__ == "__main__":
    ...
    val = "2"
    output_xyz_file = fr"C:/Users/User/Desktop/UDG_old_pc/UDG/Subjects/MIRRRRA/Final_project/training_pruebas_trans/transformed_points/outputpoints_{val}_BSpline_masked_no_moving_prueba.txt".replace("\\", "/")
